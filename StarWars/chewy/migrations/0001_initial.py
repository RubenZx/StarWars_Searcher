    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "people",
                    models.ManyToManyField(related_name="species", to="chewy.People"),
                ),
            ],
            options={"abstract": False},
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                related_name="residents", to="chewy.Planet", on_delete=models.CASCADE
            ),
        ),
        migrations.AddField(
            model_name="film",
            ...
            field=models.ManyToManyField(
                related_name="films", to="chewy.People", blank=True
            ),
        ),
        migrations.AddField(
            model_name="film",
            name="planets",
            field=models.ManyToManyField(
                related_name="films", to="chewy.Planet", blank=True
            ),
        ),
        migrations.AddField(
            model_name="film",
            name="species",
            field=models.ManyToManyField(
                related_name="films", to="chewy.Species", blank=True
            ),
        ),
        migrations.AddField(
            model_name="vehicle",
            name="pilots",
            field=models.ManyToManyField(
                related_name="vehicles", to="chewy.People", blank=True
            ),
        ),
        migrations.AddField(
            model_name="starship",
            name="pilots",
            field=models.ManyToManyField(
                related_name="starships", to="chewy.People", blank=True
            ),
        ),
        migrations.AddField(
            model_name="film",
            name="starships",
            field=models.ManyToManyField(
                related_name="films", to="chewy.Starship", blank=True
            ),
        ),
        migrations.AddField(
            model_name="film",
            name="vehicles",
            field=models.ManyToManyField(
                related_name="films", to="chewy.Vehicle", blank=True
            ),
        ),
    ]
